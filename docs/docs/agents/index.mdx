...
## Catalog Alias Behavior

Generated catalogs expose both aliases:

- unversioned (`crawler`)
- versioned (`crawler:0.0.1`)

Both map to the same spec object. UI consumers should dedupe by versionless id when listing all specs.
