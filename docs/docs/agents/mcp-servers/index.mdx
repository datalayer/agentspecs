...
existed — five servers invisible to anybody reading this page to find out
what was available.
...
### The Datalayer server is off by default
...
has the notebook it was given — enabling it says "this agent should also act
